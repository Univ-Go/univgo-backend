...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(
            ...
            throws Exception {
        http
                // TODO(security): cookie auth without CSRF protection is safe under `SameSite=Lax`
                // but not under the `SameSite=None` production needs. Must be closed before the
                // application is exposed to real users.
