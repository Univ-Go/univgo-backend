          ...
          >
            ...
            <div className="px-6 py-4 bg-gray-50 flex justify-end space-x-3">
              <button
                ...
                onClick={onClose}
                disabled={isLoading}
                className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--primary-blue)] disabled:opacity-50"
              >
                {cancelText}
              </button>
              <button
